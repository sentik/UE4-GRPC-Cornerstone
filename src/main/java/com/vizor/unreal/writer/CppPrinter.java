...
public class CppPrinter implements AutoCloseable {
    ...
    private final boolean printCodeFile;

    public CppPrinter(DestinationConfig absPathToFile, String apiName, HeaderType headerType, boolean printCodeFile) {
        this.headerType = headerType;

        this.absPathToFile = absPathToFile;
        this.decoratorWriter = new UEDecoratorWriter(apiName);
        this.printCodeFile = printCodeFile;
    ...
    public CppPrinter(DestinationConfig absPathToFile, String apiName, boolean printCodeFile) {
        this(absPathToFile, apiName, HeaderType.Public, printCodeFile);
    }
